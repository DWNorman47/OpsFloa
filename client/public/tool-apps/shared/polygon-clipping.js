/*
 * polygon-clipping v0.15.7 — robust polygon boolean ops (union / intersection /
 * difference / xor), Martinez-Rueda algorithm. MIT licensed.
 * Source: https://github.com/mfogel/polygon-clipping
 *
 * Vendored (esbuild-bundled ESM, splaytree + robust-predicates inlined) because the
 * Plan Room static tool-app loads raw ES modules and can't resolve npm bare imports.
 * Used ONLY by Plan Room (app.js), for Delete-Area cuts. The shared engine and the
 * sitework tool do NOT import this.
 *
 * To update: (in client/)
 *   npm i polygon-clipping@<ver> --no-save
 *   npx esbuild node_modules/polygon-clipping/dist/polygon-clipping.esm.js \
 *     --bundle --format=esm --platform=browser --legal-comments=none
 *   ...then prepend this header to the output.
 */
